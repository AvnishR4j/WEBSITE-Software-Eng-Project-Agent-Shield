...
export const publishedDeliverables = [
  { id: "proposal-v1", slug: "project-proposal-architecture-and-feasibility-report", title: "Project Proposal, Architecture and Feasibility Report", type: "Presentation", version: "v1", publishedDate: "2026-09-10", publishedAt: "2026-09-13T05:41:15.563903+00:00", authors: members.map((member) => member.name), changeSummary: "Established the problem, governance workflow, MVP boundaries, architecture, validation criteria and twelve-week delivery plan.", publisherEmail: members[0].email, commitUrl: null, deploymentUrl: null, changes: [{ kind: "Added", path: "AgentShield_Project_Proposal.pdf" }], assets: [{ id: "proposal-file", relativePath: "AgentShield_Project_Proposal.pdf", fileName: "AgentShield_Project_Proposal.pdf", mimeType: "application/pdf", size: 15083, sha256: "ece7d1c4f7a0a3af3e79b2b7742b3f03b31d9f4ee16268ba639fa9f87fb301a8", downloadUrl: `${siteBasePath}/deliverables/AgentShield_Project_Proposal.pdf` }] },
